...
#--- this is want to explore whether the Nabhb unique peak have more overlap with H3K56bhb-H3K27ac peak than
# overlap with WT-H3K27ac peak
...
draw_bar <- function(data,name){
  ...
  ggplot(data,aes(sample,overratio,fill=class, label = num))+
...
draw_bar(K27ac_ovK56,'H3K27ac')
ggsave('H3K27ac_overlap_H3K56bhb.pdf',width = 4, height = 5)
draw_bar(BRD4_ovK56,'BRD4')
ggsave('BRD4_overlap_H3K56bhb.pdf',width = 4, height = 5)
draw_bar(MED1_ovK56,'MED1')
ggsave('MED1_overlap_H3K56bhb.pdf',width = 4, height = 5)
