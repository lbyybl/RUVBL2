...
if [[ -f ${outputdir}/${Prefix}_stastic_all.csv ]]; then
	if [[ ! -f ${outputdir}/${Prefix}_qc.csv ]]; then
		#--- 制作bigwig		
		rm -f ${outputdir}/mapping/${Prefix}.sam ${outputdir}/mapping/${Prefix}_rmdup.bam
		rm -f ${outputdir}/cutadapt/${Prefix}_1.fq ${outputdir}/cutadapt/${Prefix}_2.fq ${outputdir}/${Prefix}_stastic.csv ${outputdir}/cutadapt/${Prefix}_trim3_1.fq ${outputdir}/cutadapt/${Prefix}_trim3_2.fq
		# rm -rf unique
	else
		rm -f ${outputdir}/mapping/${Prefix}.sam ${outputdir}/mapping/${Prefix}_rmdup.bam
		rm -f ${outputdir}/cutadapt/${Prefix}_1.fq ${outputdir}/cutadapt/${Prefix}_2.fq ${outputdir}/${Prefix}_stastic.csv ${outputdir}/cutadapt/${Prefix}_trim3_1.fq ${outputdir}/cutadapt/${Prefix}_trim3_2.fq
